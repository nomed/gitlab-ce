        ...
        <div class="text-content">
          ...
          <ul>
            <li>
              ...
              <code>{{ __('serverless.yml') }}</code> file.
            </li>
            <li>
              Your <code>{{ __('.gitlab-ci.yml') }}</code> file is not properly configured.
            </li>
            <li>
              The functions listed in the <code>{{ __('serverless.yml') }}</code> file don't match
