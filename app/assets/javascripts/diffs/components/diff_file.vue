  ...
  >
    ...
    <div v-if="forkMessageVisible" class="js-file-fork-suggestion-section file-fork-suggestion">
      <span class="file-fork-suggestion-note">
        ...
        <span class="js-file-fork-suggestion-section-action">{{ __('edit') }}</span> files in this
        project directly. Please fork this project, make your changes there, and submit a merge
        request.
      </span>
      <a
        :href="file.fork_path"
