...
Use of feature flags in development of GitLab itself is described in the
[Feature flags process documentation](https://docs.gitlab.com/ee/development/feature_flags.html).

How to add, enable/disable of feature flags is described in the
[rolling out changes using feature flags documentation](https://docs.gitlab.com/ee/development/rolling_out_changes_using_feature_flags.html).
