...
| `PRODUCTION_REPLICAS`        | The number of replicas to deploy in the production environment. This takes precedence over `REPLICAS`; defaults to 1. Zero downtime upgrades require this value to be equal or greater than 2.                                |
